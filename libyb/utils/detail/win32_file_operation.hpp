...
public:
	...
	task<size_t> read(HANDLE hFile, void * buffer, size_t size, uint64_t offset = 0);
...
private:
	...
	task<size_t> read_with_affinity(HANDLE hFile, void * buffer, size_t size, uint64_t offset);
